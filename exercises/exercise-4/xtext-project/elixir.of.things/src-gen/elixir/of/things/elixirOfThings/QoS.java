...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Qo S</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see elixir.of.things.elixirOfThings.ElixirOfThingsPackage#getQoS()
 * @model
 * @generated
 */
public enum QoS implements Enumerator
{
  /**
  ...
  /**
   * An array of all the '<em><b>Qo S</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  private static final QoS[] VALUES_ARRAY =
    new QoS[]
    {
      AT_MOST_ONCE,
      AT_LEAST_ONCE,
  ...
  /**
   * A public read-only list of all the '<em><b>Qo S</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static final List<QoS> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

  /**
   * Returns the '<em><b>Qo S</b></em>' literal with the specified literal value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public static QoS get(String literal)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      QoS result = VALUES_ARRAY[i];
  ...
  /**
   * Returns the '<em><b>Qo S</b></em>' literal with the specified name.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param name the name.
   * @return the matching enumerator or <code>null</code>.
   * @generated
   */
  public static QoS getByName(String name)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      QoS result = VALUES_ARRAY[i];
  ...
  /**
   * Returns the '<em><b>Qo S</b></em>' literal with the specified integer value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  private QoS(int value, String name, String literal)
  {
    this.value = value;
    this.name = name;
